    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portrait', models.ImageField(max_length=512, null=True, upload_to='images/portraits/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idea_source', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='author', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='NewsFollow',
            fields=[
                ...
                ('news_source', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='news.source')),
            ],
        ),
    ]
